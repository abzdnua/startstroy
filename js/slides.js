...
(function($) {
  ...
  $.widget("js.slides", {
		options: {
			...
			pauseInterval: 5000, // [Number] Time spent on pause, triggered on any navigation or pagination click
    ...
    _buildPagination: function() {
			...
			this.slides.each(
				$.proxy(function(index, element) {
					$("<li><a href='#" + index + "' class='slidesNavigation slidesPaginationItem bt_" + index + "' data-slidesindex=" + index + "> " + ( index + 1 ) + "</a></li>").appendTo(this.pagination);
				},this)
			);
